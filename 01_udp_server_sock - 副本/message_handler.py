...
class MessageHandler:
    def __init__(self, response_config=None, heartbeat_sender=None):
        ...
        self.heartbeat_sender = heartbeat_sender  # 添加 heartbeat_sender 属性
        self.logger = setup_logger('message_handler', 'logs/message_handler.log')
